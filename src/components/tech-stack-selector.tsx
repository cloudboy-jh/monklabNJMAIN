...
export function TechStackSelector({ onSelectionChange, onBuildStart }: TechStackSelectorProps) {
  ...
  const handleSelect = (category: keyof typeof techOptions, value: string) => {
    ...
    updateProgress()
    onSelectionChange(Object.values(selected).filter(Boolean) as string[])
  }
